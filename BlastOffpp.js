...
// include: /tmp/tmp2svwl3io.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/developer/source/repos/mine/blastoff/BlastOffpp.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/home/developer/source/repos/mine/blastoff/BlastOffpp.data');
      }
      Module['addRunDependency']('datafile_/home/developer/source/repos/mine/blastoff/BlastOffpp.data');
    ...
    loadPackage({"files": [{"filename": "/Ubuntu-Medium.ttf", "start": 0, "end": 285136}, {"filename": "/activeBar.png", "start": 285136, "end": 291439}, {"filename": "/barBacking.png", "start": 291439, "end": 293424}, {"filename": "/cancel.png", "start": 293424, "end": 321551}, {"filename": "/crag.png", "start": 321551, "end": 360551}, {"filename": "/downforcePowerup.png", "start": 360551, "end": 370725}, {"filename": "/egg1.wav", "start": 370725, "end": 539957}, {"filename": "/egg2.wav", "start": 539957, "end": 1236029}, {"filename": "/floatingPlatform.png", "start": 1236029, "end": 1239145}, {"filename": "/fuelBarEnergy.png", "start": 1239145, "end": 1240511}, {"filename": "/fuelupPowerup.png", "start": 1240511, "end": 1250786}, {"filename": "/highCloud.png", "start": 1250786, "end": 1256036}, {"filename": "/largeExit.png", "start": 1256036, "end": 1281777}, {"filename": "/lose.wav", "start": 1281777, "end": 1484561}, {"filename": "/lowCloud.png", "start": 1484561, "end": 1490047}, {"filename": "/mute.png", "start": 1490047, "end": 1521973}, {"filename": "/no.png", "start": 1521973, "end": 1550883}, {"filename": "/play.png", "start": 1550883, "end": 1578976}, {"filename": "/reset.png", "start": 1578976, "end": 1609102}, {"filename": "/rifftastic.ogg", "start": 1609102, "end": 8743674}, {"filename": "/save.png", "start": 8743674, "end": 8771802}, {"filename": "/settings.png", "start": 8771802, "end": 8813353}, {"filename": "/smallExit.png", "start": 8813353, "end": 8840818}, {"filename": "/spaceship.png", "start": 8840818, "end": 8851597}, {"filename": "/spaceshipFlames.png", "start": 8851597, "end": 8853680}, {"filename": "/spawnPlatform.png", "start": 8853680, "end": 8860345}, {"filename": "/speedBarEnergy.png", "start": 8860345, "end": 8861746}, {"filename": "/speedupPowerup.png", "start": 8861746, "end": 8874973}, {"filename": "/win.wav", "start": 8874973, "end": 9055627}, {"filename": "/yes.png", "start": 9055627, "end": 9082353}], "remote_package_size": 9082353});

  })();

// end include: /tmp/tmp2svwl3io.js
// include: /tmp/tmpbzgj80qd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpbzgj80qd.js
// include: /tmp/tmpf8t0j3le.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpf8t0j3le.js
...
var ASM_CONSTS = {
  301632: () => { let canvas = document.querySelector("canvas"); let rect = canvas.getBoundingClientRect(); return rect.left; },  
 301744: () => { let canvas = document.querySelector("canvas"); let rect = canvas.getBoundingClientRect(); return rect.top; },  
 301855: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 304033: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 304337: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 304441: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 304612: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 307489: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 307562: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 307962: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 308012: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 308151: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 308291: () => { if (document.fullscreenElement) return 1; },  
 308337: () => { return Module.canvas.width; },  
 308369: () => { return parseInt(Module.canvas.style.width); },  
 308417: () => { document.exitFullscreen(); },  
 308444: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 308516: () => { if (document.fullscreenElement) return 1; },  
 308562: () => { return Module.canvas.width; },  
 308594: () => { return screen.width; },  
 308619: () => { document.exitFullscreen(); },  
 308646: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 308840: () => { return window.innerWidth; },  
 308866: () => { return window.innerHeight; },  
 308893: () => { if (document.fullscreenElement) return 1; },  
 308939: () => { return Module.canvas.width; },  
 308971: () => { return parseInt(Module.canvas.style.width); },  
 309019: () => { if (document.fullscreenElement) return 1; },  
 309065: () => { return Module.canvas.width; },  
 309097: () => { return screen.width; },  
 309122: () => { return window.innerWidth; },  
 309148: () => { return window.innerHeight; },  
 309175: () => { if (document.fullscreenElement) return 1; },  
 309221: () => { return Module.canvas.width; },  
 309253: () => { return screen.width; },  
 309278: () => { document.exitFullscreen(); },  
 309305: () => { if (document.fullscreenElement) return 1; },  
 309351: () => { return Module.canvas.width; },  
 309383: () => { return parseInt(Module.canvas.style.width); },  
 309431: () => { document.exitFullscreen(); },  
 309458: ($0) => { Module.canvas.style.opacity = $0; },  
 309496: () => { return screen.width; },  
 309521: () => { return screen.height; },  
 309547: () => { return window.screenX; },  
 309574: () => { return window.screenY; },  
 309601: () => { return window.devicePixelRatio; },  
 309637: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 309690: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 309741: () => { Module.canvas.style.cursor = 'none'; },  
 309778: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 310034: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 310085: () => { if (document.pointerLockElement) return 1; },  
 310132: () => { if (document.fullscreenElement) return 1; },  
 310178: () => { return window.innerWidth; },  
 310204: () => { return window.innerHeight; }
};
